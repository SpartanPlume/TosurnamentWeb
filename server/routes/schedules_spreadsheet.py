...
to_query = SchedulesSpreadsheet

class Tosurnament(Base):
    """/schedules_spreadsheet route handler"""
    ROUTE = "/schedules_spreadsheet"
    ...
    def put(handler, path, parameters):
        ...
        if path:
            ...
            print("Schedules Spreadsheet updated")
            handler.send_json("{}")                
        else:
